...
import { User, Mic, Image as ImageIcon, ClipboardList, BarChart, Pill, Hospital, Calendar, AlertTriangle, Target, Download, Printer, Share2, ArrowLeft } from "lucide-react";
      ...
      <main className="report-page">
        <div className="report-paper" id="report-printable">
          ...
          <section className="report-section">
            <h3><User size={20}/> Patient Summary</h3>
          ...
          {/* 3. Chief Complaint */}
          <section className="report-section">
            <h3><Mic size={20}/> Chief Complaint</h3>
          ...
          {vf && (
            <section className="report-section">
              <h3><ImageIcon size={20}/> Image Analysis</h3>
          ...
          {/* 5. Primary Diagnosis */}
          <section className="report-section">
            <h3><ClipboardList size={20}/> Primary Diagnosis</h3>
          ...
          {differentials.length > 0 && (
            <section className="report-section">
              <h3><BarChart size={20}/> Differential Diagnoses</h3>
          ...
          {/* 7. Treatment Plan */}
          <section className="report-section">
            <h3><Pill size={20}/> Treatment Plan</h3>
            <p>{treatment}</p>
          </section>

          {/* 8. Specialist Routing */}
          <section className="report-section">
            <h3><Hospital size={20}/> Specialist Routing</h3>
          ...
          {appointment && (
            <section className="report-section report-appointment">
              <h3><Calendar size={20}/> Specialist Appointment (Booked by AI)</h3>
          ...
          {(redFlags.length > 0 || record.flagged) && (
            <section className="report-section report-safety">
              <h3><AlertTriangle size={20}/> Safety Flags</h3>
          ...
          {/* 11. Confidence Score */}
          <section className="report-section">
            <h3><Target size={20}/> AI Confidence Score</h3>
          ...
          <section className="report-disclaimer">
            <p><AlertTriangle size={16} style={{display:'inline', marginBottom:'-3px'}}/> This report is generated by MediAI for clinical decision support only. It does not constitute medical advice. Always consult a qualified healthcare professional before making treatment decisions.</p>
          </section>
        </div>

        {/* Action Buttons */}
        <div className="report-actions">
          <button className="primary-button" onClick={handlePrint}><Download size={16}/> Download PDF</button>
          <button className="secondary-button" onClick={handlePrint}><Printer size={16}/> Print</button>
          <button className="secondary-button" onClick={() => navigator.clipboard?.writeText(window.location.href).then(() => setToast?.("Link copied"))}><Share2 size={16}/> Share</button>
